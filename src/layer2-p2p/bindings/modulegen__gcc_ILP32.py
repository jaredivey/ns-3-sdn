...
def module_init():
    root_module = Module('ns.layer2_p2p', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::Layer2P2PHelper [class]
    module.add_class('Layer2P2PHelper', parent=[root_module['ns3::PcapHelperForDevice'], root_module['ns3::AsciiTraceHelperForDevice']])
    ...
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Layer2P2PChannel [class]
    module.add_class('Layer2P2PChannel', parent=root_module['ns3::Channel'])
    ## layer2-p2p-remote-channel.h (module 'layer2-p2p'): ns3::Layer2P2PRemoteChannel [class]
    module.add_class('Layer2P2PRemoteChannel', parent=root_module['ns3::Layer2P2PChannel'])
    ...
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Layer2P2PNetDevice [class]
    module.add_class('Layer2P2PNetDevice', parent=root_module['ns3::NetDevice'])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Layer2P2PNetDevice::EncapsulationMode [enumeration]
    module.add_enum('EncapsulationMode', ['ILLEGAL', 'DIX', 'LLC'], outer_class=root_module['ns3::Layer2P2PNetDevice'])
...
def register_methods(root_module):
    ...
    register_Ns3Layer2P2PHelper_methods(root_module, root_module['ns3::Layer2P2PHelper'])
    ...
    register_Ns3Layer2P2PChannel_methods(root_module, root_module['ns3::Layer2P2PChannel'])
    register_Ns3Layer2P2PRemoteChannel_methods(root_module, root_module['ns3::Layer2P2PRemoteChannel'])
    ...
    register_Ns3Layer2P2PNetDevice_methods(root_module, root_module['ns3::Layer2P2PNetDevice'])
...
def register_Ns3Layer2P2PHelper_methods(root_module, cls):
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::Layer2P2PHelper::Layer2P2PHelper(ns3::Layer2P2PHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::Layer2P2PHelper const &', 'arg0')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::Layer2P2PHelper::Layer2P2PHelper() [constructor]
    cls.add_constructor([])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::NetDeviceContainer ns3::Layer2P2PHelper::Install(ns3::NodeContainer c) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::NodeContainer', 'c')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::NetDeviceContainer ns3::Layer2P2PHelper::Install(ns3::Ptr<ns3::Node> a, ns3::Ptr<ns3::Node> b) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'a'), param('ns3::Ptr< ns3::Node >', 'b')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::NetDeviceContainer ns3::Layer2P2PHelper::Install(ns3::Ptr<ns3::Node> a, std::string bName) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'a'), param('std::string', 'bName')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::NetDeviceContainer ns3::Layer2P2PHelper::Install(std::string aName, ns3::Ptr<ns3::Node> b) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'aName'), param('ns3::Ptr< ns3::Node >', 'b')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): ns3::NetDeviceContainer ns3::Layer2P2PHelper::Install(std::string aNode, std::string bNode) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'aNode'), param('std::string', 'bNode')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): void ns3::Layer2P2PHelper::SetChannelAttribute(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('SetChannelAttribute', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): void ns3::Layer2P2PHelper::SetDeviceAttribute(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('SetDeviceAttribute', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): void ns3::Layer2P2PHelper::SetQueue(std::string type, std::string n1="", ns3::AttributeValue const & v1=ns3::EmptyAttributeValue(), std::string n2="", ns3::AttributeValue const & v2=ns3::EmptyAttributeValue(), std::string n3="", ns3::AttributeValue const & v3=ns3::EmptyAttributeValue(), std::string n4="", ns3::AttributeValue const & v4=ns3::EmptyAttributeValue()) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('std::string', 'type'), param('std::string', 'n1', default_value='""'), param('ns3::AttributeValue const &', 'v1', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n2', default_value='""'), param('ns3::AttributeValue const &', 'v2', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n3', default_value='""'), param('ns3::AttributeValue const &', 'v3', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n4', default_value='""'), param('ns3::AttributeValue const &', 'v4', default_value='ns3::EmptyAttributeValue()')])
    ## layer2-p2p-helper.h (module 'layer2-p2p'): void ns3::Layer2P2PHelper::EnableAsciiInternal(ns3::Ptr<ns3::OutputStreamWrapper> stream, std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool explicitFilename) [member function]
    cls.add_method('EnableAsciiInternal', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
    ## layer2-p2p-helper.h (module 'layer2-p2p'): void ns3::Layer2P2PHelper::EnablePcapInternal(std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool promiscuous, bool explicitFilename) [member function]
    cls.add_method('EnablePcapInternal', 
                   'void', 
                   [param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'promiscuous'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3Layer2P2PChannel_methods(root_module, cls):
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Layer2P2PChannel::Layer2P2PChannel(ns3::Layer2P2PChannel const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::Layer2P2PChannel const &', 'arg0')])
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Layer2P2PChannel::Layer2P2PChannel() [constructor]
    cls.add_constructor([])
    ## layer2-p2p-channel.h (module 'layer2-p2p'): void ns3::Layer2P2PChannel::Attach(ns3::Ptr<ns3::Layer2P2PNetDevice> device) [member function]
    cls.add_method('Attach', 
                   'void', 
                   [param('ns3::Ptr< ns3::Layer2P2PNetDevice >', 'device')])
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Ptr<ns3::NetDevice> ns3::Layer2P2PChannel::GetDevice(uint32_t i) const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Ptr<ns3::Layer2P2PNetDevice> ns3::Layer2P2PChannel::GetLayer2P2PDevice(uint32_t i) const [member function]
    cls.add_method('GetLayer2P2PDevice', 
                   'ns3::Ptr< ns3::Layer2P2PNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True)
    ## layer2-p2p-channel.h (module 'layer2-p2p'): uint32_t ns3::Layer2P2PChannel::GetNDevices() const [member function]
    cls.add_method('GetNDevices', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-channel.h (module 'layer2-p2p'): static ns3::TypeId ns3::Layer2P2PChannel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## layer2-p2p-channel.h (module 'layer2-p2p'): bool ns3::Layer2P2PChannel::TransmitStart(ns3::Ptr<ns3::Packet> p, ns3::Ptr<ns3::Layer2P2PNetDevice> src, ns3::Time txTime) [member function]
    cls.add_method('TransmitStart', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ptr< ns3::Layer2P2PNetDevice >', 'src'), param('ns3::Time', 'txTime')], 
                   is_virtual=True)
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Time ns3::Layer2P2PChannel::GetDelay() const [member function]
    cls.add_method('GetDelay', 
                   'ns3::Time', 
                   [], 
                   is_const=True, visibility='protected')
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Ptr<ns3::Layer2P2PNetDevice> ns3::Layer2P2PChannel::GetDestination(uint32_t i) const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ptr< ns3::Layer2P2PNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, visibility='protected')
    ## layer2-p2p-channel.h (module 'layer2-p2p'): ns3::Ptr<ns3::Layer2P2PNetDevice> ns3::Layer2P2PChannel::GetSource(uint32_t i) const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ptr< ns3::Layer2P2PNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, visibility='protected')
    ## layer2-p2p-channel.h (module 'layer2-p2p'): bool ns3::Layer2P2PChannel::IsInitialized() const [member function]
...
def register_Ns3Layer2P2PRemoteChannel_methods(root_module, cls):
    ## layer2-p2p-remote-channel.h (module 'layer2-p2p'): ns3::Layer2P2PRemoteChannel::Layer2P2PRemoteChannel(ns3::Layer2P2PRemoteChannel const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::Layer2P2PRemoteChannel const &', 'arg0')])
    ## layer2-p2p-remote-channel.h (module 'layer2-p2p'): ns3::Layer2P2PRemoteChannel::Layer2P2PRemoteChannel() [constructor]
    cls.add_constructor([])
    ## layer2-p2p-remote-channel.h (module 'layer2-p2p'): static ns3::TypeId ns3::Layer2P2PRemoteChannel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## layer2-p2p-remote-channel.h (module 'layer2-p2p'): bool ns3::Layer2P2PRemoteChannel::TransmitStart(ns3::Ptr<ns3::Packet> p, ns3::Ptr<ns3::Layer2P2PNetDevice> src, ns3::Time txTime) [member function]
    cls.add_method('TransmitStart', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ptr< ns3::Layer2P2PNetDevice >', 'src'), param('ns3::Time', 'txTime')], 
                   is_virtual=True)
...
def register_Ns3Layer2P2PNetDevice_methods(root_module, cls):
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): static ns3::TypeId ns3::Layer2P2PNetDevice::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Layer2P2PNetDevice::Layer2P2PNetDevice() [constructor]
    cls.add_constructor([])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetDataRate(ns3::DataRate bps) [member function]
    cls.add_method('SetDataRate', 
                   'void', 
                   [param('ns3::DataRate', 'bps')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetInterframeGap(ns3::Time t) [member function]
    cls.add_method('SetInterframeGap', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::Attach(ns3::Ptr<ns3::Layer2P2PChannel> ch) [member function]
    cls.add_method('Attach', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Layer2P2PChannel >', 'ch')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetQueue(ns3::Ptr<ns3::Queue> queue) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('ns3::Ptr< ns3::Queue >', 'queue')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Ptr<ns3::Queue> ns3::Layer2P2PNetDevice::GetQueue() const [member function]
    cls.add_method('GetQueue', 
                   'ns3::Ptr< ns3::Queue >', 
                   [], 
                   is_const=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetReceiveErrorModel(ns3::Ptr<ns3::ErrorModel> em) [member function]
    cls.add_method('SetReceiveErrorModel', 
                   'void', 
                   [param('ns3::Ptr< ns3::ErrorModel >', 'em')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::Receive(ns3::Ptr<ns3::Packet> p) [member function]
    cls.add_method('Receive', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'p')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::IsSdnEnabled() [member function]
    cls.add_method('IsSdnEnabled', 
                   'bool', 
                   [])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetSdnEnable(bool enable) [member function]
    cls.add_method('SetSdnEnable', 
                   'void', 
                   [param('bool', 'enable')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetEncapsulationMode(ns3::Layer2P2PNetDevice::EncapsulationMode mode) [member function]
    cls.add_method('SetEncapsulationMode', 
                   'void', 
                   [param('ns3::Layer2P2PNetDevice::EncapsulationMode', 'mode')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Layer2P2PNetDevice::EncapsulationMode ns3::Layer2P2PNetDevice::GetEncapsulationMode() [member function]
    cls.add_method('GetEncapsulationMode', 
                   'ns3::Layer2P2PNetDevice::EncapsulationMode', 
                   [])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetSdnReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetSdnReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'cb')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetIfIndex(uint32_t const index) [member function]
    cls.add_method('SetIfIndex', 
                   'void', 
                   [param('uint32_t const', 'index')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): uint32_t ns3::Layer2P2PNetDevice::GetIfIndex() const [member function]
    cls.add_method('GetIfIndex', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Ptr<ns3::Channel> ns3::Layer2P2PNetDevice::GetChannel() const [member function]
    cls.add_method('GetChannel', 
                   'ns3::Ptr< ns3::Channel >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetAddress(ns3::Address address) [member function]
    cls.add_method('SetAddress', 
                   'void', 
                   [param('ns3::Address', 'address')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Address ns3::Layer2P2PNetDevice::GetAddress() const [member function]
    cls.add_method('GetAddress', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::SetMtu(uint16_t const mtu) [member function]
    cls.add_method('SetMtu', 
                   'bool', 
                   [param('uint16_t const', 'mtu')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): uint16_t ns3::Layer2P2PNetDevice::GetMtu() const [member function]
    cls.add_method('GetMtu', 
                   'uint16_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::IsLinkUp() const [member function]
    cls.add_method('IsLinkUp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::AddLinkChangeCallback(ns3::Callback<void,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> callback) [member function]
    cls.add_method('AddLinkChangeCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::IsBroadcast() const [member function]
    cls.add_method('IsBroadcast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Address ns3::Layer2P2PNetDevice::GetBroadcast() const [member function]
    cls.add_method('GetBroadcast', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::IsMulticast() const [member function]
    cls.add_method('IsMulticast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Address ns3::Layer2P2PNetDevice::GetMulticast(ns3::Ipv4Address multicastGroup) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv4Address', 'multicastGroup')], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::IsPointToPoint() const [member function]
    cls.add_method('IsPointToPoint', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::IsBridge() const [member function]
    cls.add_method('IsBridge', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::Send(ns3::Ptr<ns3::Packet> packet, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('Send', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::SendFrom(ns3::Ptr<ns3::Packet> packet, ns3::Address const & source, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('SendFrom', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'source'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Ptr<ns3::Node> ns3::Layer2P2PNetDevice::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::NeedsArp() const [member function]
    cls.add_method('NeedsArp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): ns3::Address ns3::Layer2P2PNetDevice::GetMulticast(ns3::Ipv6Address addr) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv6Address', 'addr')], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::SetPromiscReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::Address const&, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetPromiscReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::Address const &, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): bool ns3::Layer2P2PNetDevice::SupportsSendFrom() const [member function]
    cls.add_method('SupportsSendFrom', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::DoMpiReceive(ns3::Ptr<ns3::Packet> p, ns3::Ptr<ns3::NetDevice> sender) [member function]
    cls.add_method('DoMpiReceive', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ptr< ns3::NetDevice >', 'sender')])
    ## layer2-p2p-net-device.h (module 'layer2-p2p'): void ns3::Layer2P2PNetDevice::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)

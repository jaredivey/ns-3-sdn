...
main (int argc, char *argv[])
{
  ...
  Ptr<Layer2P2PNetDevice> net0 = CreateObject<Layer2P2PNetDevice> ();
  n0->AddDevice (net0);
  ...
  // single Layer2P2PNetDevice (NetDevice 0) and added a
  // DropTailQueue to it.
  ...
  // queue via the Layer2P2PNetDevice attributes, where it is called
  // TxQueue 
  PointerValue ptr;

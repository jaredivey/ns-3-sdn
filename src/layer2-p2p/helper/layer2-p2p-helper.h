 ...
 */
#ifndef LAYER2_P2P_HELPER_H
#define LAYER2_P2P_HELPER_H
...
/**
 * \brief Build a set of Layer2P2PNetDevice objects
 *
 * Normally we eschew multiple inheritance, however, the classes 
 * PcapUserHelperForDevice and AsciiTraceUserHelperForDevice are
 * "mixins".
 */
class Layer2P2PHelper : public PcapHelperForDevice,
	                   public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a Layer2P2PHelper to make life easier when creating point to
   * point networks.
   */
  Layer2P2PHelper ();
  virtual ~Layer2P2PHelper () {}
   ...
   * Layer2P2PNetDevice created through Layer2P2PHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::Layer2P2PNetDevice created
   * by Layer2P2PHelper::Install
   */
   ...
   * \param value the value of the attribute to set
   *
   * Set these attribute on each ns3::Layer2P2PChannel created
   * by Layer2P2PHelper::Install
   */
   ...
   *
   * This method creates a ns3::Layer2P2PChannel with the
   * attributes configured by Layer2P2PHelper::SetChannelAttribute,
   * then, for each node in the input container, we create a 
   * ns3::Layer2P2PNetDevice with the requested attributes,
   * a queue for this ns3::NetDevice, and associate the resulting 
   * ns3::NetDevice with the ns3::Node and ns3::Layer2P2PChannel.
   */

...
def register_Ns3V4Ping_methods(root_module, cls):
    ...
    cls.add_method('GetTypeId', 
                   ...
                   [], 
                   is_static=True)
    ## v4ping.h (module 'applications'): ns3::V4Ping::m_totalRecv [variable]
    cls.add_static_attribute('m_totalRecv', 'uint32_t', is_const=False)
    ## v4ping.h (module 'applications'): ns3::V4Ping::m_totalSend [variable]
    cls.add_static_attribute('m_totalSend', 'uint32_t', is_const=False)
